  ...
  return (
    <div>
      ...
      <div style={{display:'grid', gap:12}}>
        {items.map((l) => (
          <div key={l.id} style={{padding:12, border:'1px solid #e5e7eb', borderRadius:8, background:'#fff', display:'flex', justifyContent:'space-between', alignItems:'center'}}>
            <div>
            ...
            <div style={{display:'flex', gap:8}}>
              ...
              <button onClick={async ()=>{
                ...
                setItems(all.filter(p => p.userId === user?.id))
